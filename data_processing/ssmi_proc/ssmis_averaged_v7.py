...
class SSMISaveraged(Dataset):
    """ Read averaged SSMIS bytemaps. """
    """
    Public data:
...
class ThreedayVerify(Verify):
    ...
    def __init__(self,dataset):
        self.filename = 'Verify_SSMIS_v7.txt'
        self.ilon1 = 170
        self.ilon2 = 175
        self.ilat1 = 274
        self.ilat2 = 278                
        self.variables = ['wspd_mf','vapor','cloud','rain']
        self.startline = {'wspd_mf' : 105,
                          'vapor' : 112,
                          'cloud' : 119,
                          'rain' : 126 }
...
if __name__ == '__main__':
    ...
    # read 3-day averaged:
    ssmi = SSMISaveraged('f17_20090120v7_d3d.gz')
    ...
    ssmi = SSMISaveraged('f17_20090124v7.gz')
    if not ssmi.variables: sys.exit('file not found')
    ...
    ssmi = SSMISaveraged('f17_200901v7.gz')
    if not ssmi.variables: sys.exit('file not found')
